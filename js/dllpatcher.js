...
class PatchContainer {
    ...
    createUI() {
        ...
        label.innerHTML = "<strong>选择一个文件</strong> 或者把文件投喂给我";
        ...
        container.appendChild(createElementClass('h4', null, '支持的版本:'));
        container.appendChild(createElementClass('h5', null, '单击「版本」预览补丁'));
